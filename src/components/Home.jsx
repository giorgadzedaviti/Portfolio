  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
      ...
      <div className='max-w-[1000px] mx-auto px-1 flex flex-col justify-center h-full'>
        ...
        <div>
            <button className=' text-white group border-2 px-6 py-0 my-3 flex items-center hover:bg-red-600 hover:border-black object-center'><Link to="skills" smooth={true} duration={500}>View Skills
